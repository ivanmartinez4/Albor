...
$(OBJEVENTGFXDIR)/pokemon/hisuian_growlithe.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/castform_sandy.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/gimmighoul/chest.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
