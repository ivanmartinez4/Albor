...
static void StartSendOutAnimFollower(u8, bool8, bool8);
...
static void PlayerHandleSwitchInAnim(void)
{
    ...
    StartSendOutAnimFollower(gActiveBattler, gBattleResources->bufferA[gActiveBattler][2], FALSE);
...
static void StartSendOutAnimFollower(u8 battlerId, bool8 dontClearSubstituteBit, bool8 doSlideIn)
{
    u16 species;
...
static void Task_StartSendOutAnim(u8 taskId)
{
    ...
    else
    {
        ...
        if (!TwoIntroMons(gActiveBattler) && !(gBattleTypeFlags & BATTLE_TYPE_MULTI))
        {
            ...
            StartSendOutAnimFollower(gActiveBattler, FALSE, ShouldDoSlideInAnim());
        }
        else
        {
            gBattleBufferA[gActiveBattler][1] = gBattlerPartyIndexes[gActiveBattler];
            StartSendOutAnimF+(gActiveBattler, FALSE, ShouldDoSlideInAnim());
