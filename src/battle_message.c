...
static const u8 sText_NotVeryEffective[] = _("{COLOR LIGHT_BLUE}It's not very effective…");
static const u8 sText_SuperEffective[] = _("{COLOR RED}It's super effective!");
