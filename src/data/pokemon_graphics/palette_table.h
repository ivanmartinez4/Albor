...
{
    SPECIES_PAL(EEVEE, gMonPalette_EeveeF),
    SPECIES_PAL(COMBEE, gMonPalette_CombeeF),
    SPECIES_PAL(STARLY, gMonPalette_StarlyF),
    SPECIES_PAL(STARAVIA, gMonPalette_StaraviaF),
    SPECIES_PAL(STARAPTOR, gMonPalette_StaraptorF),
    SPECIES_PAL(BIDOOF, gMonPalette_BidoofF),
    SPECIES_PAL(KRICKETOT, gMonPalette_KricketotF),
    SPECIES_PAL(KRICKETUNE, gMonPalette_KricketuneF),
    SPECIES_PAL(SHINX, gMonPalette_ShinxF),
