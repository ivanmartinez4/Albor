...
{
    SPECIES_SHINY_PAL(EEVEE, gMonShinyPalette_EeveeF),
    SPECIES_SHINY_PAL(STARLY, gMonShinyPalette_StarlyF),
    SPECIES_SHINY_PAL(STARAVIA, gMonShinyPalette_StaraviaF),
    SPECIES_SHINY_PAL(STARAPTOR, gMonShinyPalette_StaraptorF),
    SPECIES_SHINY_PAL(BIDOOF, gMonShinyPalette_BidoofF),
    SPECIES_SHINY_PAL(KRICKETOT, gMonShinyPalette_KricketotF),
    SPECIES_SHINY_PAL(KRICKETUNE, gMonShinyPalette_KricketuneF),
    SPECIES_SHINY_PAL(SHINX, gMonShinyPalette_ShinxF),
