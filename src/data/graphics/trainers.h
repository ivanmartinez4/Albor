...
const u32 gTrainerPalette_AdventuresBrendan[] = INCBIN_U32("graphics/trainers/palettes/adventures_brendan.gbapal.lz");

const u32 gTrainerFrontPic_AdventuresMay[] = INCBIN_U32("graphics/trainers/front_pics/adventures_may_front_pic.4bpp.lz");
const u32 gTrainerPalette_AdventuresMay[] = INCBIN_U32("graphics/trainers/palettes/adventures_may.gbapal.lz");
