const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 30, SPECIES_MIENSHAO}},
    ...
    [SPECIES_SPRIGATITO]            = {{EVO_LEVEL, 20, SPECIES_FLORAGATO}},
    [SPECIES_FLORAGATO]             = {{EVO_LEVEL, 40, SPECIES_MEOWSCARADA}},
    [SPECIES_FUECOCO]               = {{EVO_LEVEL, 20, SPECIES_CROCALOR}},
    [SPECIES_CROCALOR]              = {{EVO_LEVEL, 40, SPECIES_SKELEDIRGE}},
    [SPECIES_QUAXLY]                = {{EVO_LEVEL, 20, SPECIES_QUAXWELL}},
    [SPECIES_QUAXWELL]              = {{EVO_LEVEL, 40, SPECIES_QUAQUAVAL}},
    [SPECIES_NYMBLE]                = {{EVO_LEVEL, 30, SPECIES_NYMBLE}},
    [SPECIES_SMOLIV]                = {{EVO_LEVEL, 20, SPECIES_DOLLIV}},
    [SPECIES_DOLLIV]                = {{EVO_LEVEL, 40, SPECIES_ARBOLIVA}},
    [SPECIES_TADBULB]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_BELLIBOLT}},
    [SPECIES_SHROODLE]              = {{EVO_LEVEL, 30, SPECIES_GRAFAIAI}},
    [SPECIES_CAPSAKID]              = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_SCOVILLAIN}},
    [SPECIES_FLITTLE]               = {{EVO_LEVEL, 30, SPECIES_ESPATHRA}},
    [SPECIES_TINKATINK]             = {{EVO_LEVEL, 20, SPECIES_TINKATUFF}},
    [SPECIES_TINKATUFF]             = {{EVO_LEVEL, 40, SPECIES_TINKATON}},
    [SPECIES_VAROOM]                = {{EVO_LEVEL, 30, SPECIES_REVAVROOM}},
    [SPECIES_GREAVARD]              = {{EVO_LEVEL_NIGHT, 30, SPECIES_HOUNDSTONE}},
    [SPECIES_CETODDLE]              = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_CETITAN}},
    [SPECIES_FRIGIBAX]              = {{EVO_LEVEL, 30, SPECIES_ARCTIBAX}},
    [SPECIES_ARCTIBAX]              = {{EVO_LEVEL, 50, SPECIES_BAXCALIBUR}},
    [SPECIES_GIMMIGHOUL]            = {{EVO_MOVE, MOVE_MAKE_IT_RAIN, SPECIES_GHOLDENGO}},
    [SPECIES_GIMMIGHOUL_CHEST]      = {{EVO_MOVE, MOVE_MAKE_IT_RAIN, SPECIES_GHOLDENGO}},
    [SPECIES_CHARCADEL]             = {{EVO_MOVE_TYPE, TYPE_PSYCHIC, SPECIES_ARMAROUGE},
                                       {EVO_MOVE_TYPE, TYPE_GHOST, SPECIES_CERULEDGE}},
};
