const struct PokedexEntry gPokedexEntries[] =
{
    ...
    {
        .categoryName = _("Ratón eléctrico"),
        .height = 4,
        .weight = 60,
    ...
    [NATIONAL_DEX_RAICHU] =
    {
        .categoryName = _("Roedor eléctrico"),
        .height = 8,
        .weight = 300,
    ...
    {
        .categoryName = _("Coneja venenosa"),
        .height = 4,
        .weight = 70,
    ...
    {
        .categoryName = _("Pacarana hembra"),
        .height = 8,
        .weight = 200,
    ...
    {
        .categoryName = _("Conejo venenoso"),
        .height = 5,
        .weight = 90,
    ...
    {
        .categoryName = _("Zorro legendario"),
        .height = 11,
        .weight = 199,
    ...
    {
        .categoryName = _("Planta carnívora"),
        .height = 17,
        .weight = 155,
    ...
    {
        .categoryName = _("Cangrejo hermitaño"),
        .height = 16,
        .weight = 785,
    ...
    [NATIONAL_DEX_DODRIO] =
    {
        .categoryName = _("Triple avestruz"),
        .height = 18,
        .weight = 852,
    ...
    [NATIONAL_DEX_ONIX] =
    {
        .categoryName = _("Serpiente rocosa"),
        .height = 88,
        .weight = 2100,
    ...
    [NATIONAL_DEX_HORSEA] =
    {
        .categoryName = _("Caballito de mar"),
        .height = 4,
        .weight = 80,
    ...
    {
        .categoryName = _("Dragón elegante"),
        .height = 40,
        .weight = 165,
    ...
    [NATIONAL_DEX_LEDIAN] =
    {
        .categoryName = _("Mariquita boxeadora"),
        .height = 14,
        .weight = 356,
    ...
    {
        .categoryName = _("Oveja eléctrica"),
        .height = 8,
        .weight = 133,
    ...
    {
        .categoryName = _("Serpiente dichosa"),
        .height = 15,
        .weight = 140,
    ...
    {
        .categoryName = _("Serpiente de hierro"),
        .height = 92,
        .weight = 4000,
    ...
    {
        .categoryName = _("Caracol de lava"),
        .height = 8,
        .weight = 550,
    ...
    {
        .categoryName = _("Pájaro metálico"),
        .height = 17,
        .weight = 505,
    ...
    [NATIONAL_DEX_RAIKOU] =
    {
        .categoryName = _("Señor del trueno"),
        .height = 19,
        .weight = 1780,
    ...
    [NATIONAL_DEX_ENTEI] =
    {
        .categoryName = _("Emperador del fuego"),
        .height = 21,
        .weight = 1980,
    ...
    {
        .categoryName = _("Larva de alquitrán"),
        .height = 6,
        .weight = 720,
    ...
    {
        .categoryName = _("Pupa de alquitrán"),
        .height = 12,
        .weight = 1520,
    ...
    {
        .categoryName = _("Reptil de árbol"),
        .height = 9,
        .weight = 216,
    ...
    {
        .categoryName = _("Pez del pantano"),
        .height = 7,
        .weight = 280,
    ...
    {
        .categoryName = _("Bestia del pantano"),
        .height = 15,
        .weight = 819,
    ...
    {
        .categoryName = _("Hermosa mariposa"),
        .height = 10,
        .weight = 284,
    ...
    [NATIONAL_DEX_DUSTOX] =
    {
        .categoryName = _("Polilla de polvo"),
        .height = 12,
        .weight = 316,
    ...
    [NATIONAL_DEX_LOTAD] =
    {
        .categoryName = _("Semilla acuática"),
        .height = 5,
        .weight = 26,
    ...
    {
        .categoryName = _("Bebé golondrina"),
        .height = 3,
        .weight = 23,
    ...
    {
        .categoryName = _("Tarta de hongos"),
        .height = 4,
        .weight = 45,
    ...
    [NATIONAL_DEX_AGGRON] =
    {
        .categoryName = _("Dragón de metal"),
        .height = 21,
        .weight = 3600,
    ...
    {
        .categoryName = _("Perro eléctrico"),
        .height = 6,
        .weight = 152,
    ...
    {
        .categoryName = _("Tortuga de fuego"),
        .height = 5,
        .weight = 804,
    ...
    [NATIONAL_DEX_FLYGON] =
    {
        .categoryName = _("Libélula dragón"),
        .height = 20,
        .weight = 820,
    ...
    {
        .categoryName = _("Serpiente marina"),
        .height = 17,
        .weight = 270,
    ...
    {
        .categoryName = _("Dragón salamandra"),
        .height = 15,
        .weight = 1026,
    ...
    {
        .categoryName = _("Brazo de hierro"),
        .height = 16,
        .weight = 5500,
    ...
    [NATIONAL_DEX_STARLY] =
    {
        .categoryName = _("Cría de estornino"),
        .height = 3,
        .weight = 20,
    ...
    {
        .categoryName = _("Escarabajo violín"),
        .height = 10,
        .weight = 255,
    ...
    [NATIONAL_DEX_LUXRAY] =
    {
        .categoryName = _("Tigre eléctrico"),
        .height = 14,
        .weight = 420,
    ...
    {
        .categoryName = _("Ardilla eléctrica"),
        .height = 4,
        .weight = 39,
    ...
    {
        .categoryName = _("Conejo luchador"),
        .height = 12,
        .weight = 333,
    ...
    [NATIONAL_DEX_GIBLE] =
    {
        .categoryName = _("Tiburón martillo"),
        .height = 7,
        .weight = 205,
    ...
    [NATIONAL_DEX_GABITE] =
    {
        .categoryName = _("Tiburón de cueva"),
        .height = 14,
        .weight = 560,
    ...
    {
        .categoryName = _("Tiburón de tierra"),
        .height = 19,
        .weight = 950,
    ...
    {
        .categoryName = _("Tormenta de arena"),
        .height = 20,
        .weight = 3000,
    ...
    {
        .categoryName = _("Escorpión venenoso"),
        .height = 13,
        .weight = 615,
    ...
    {
        .categoryName = _("Electromagnético"),
        .height = 12,
        .weight = 1800,
    ...
    {
        .categoryName = _("Lengua pegajosa"),
        .height = 17,
        .weight = 1400,
    ...
    {
        .categoryName = _("Cable eléctrico"),
        .height = 18,
        .weight = 1386,
    ...
    {
        .categoryName = _("Libélula prehistórica"),
        .height = 19,
        .weight = 515,
    ...
    {
        .categoryName = _("Murciélago terrestre"),
        .height = 20,
        .weight = 425,
    ...
    {
        .categoryName = _("Metal de transición"),
        .height = 17,
        .weight = 4300,
    ...
    {
        .categoryName = _("Cerdo murciélago"),
        .height = 9,
        .weight = 105,
    ...
    {
        .categoryName = _("Bola de algodón"),
        .height = 3,
        .weight = 6,
    ...
    {
        .categoryName = _("Cocodrilo de arena"),
        .height = 7,
        .weight = 152,
    ...
    {
        .categoryName = _("Cocodrilo de roca"),
        .height = 10,
        .weight = 334,
    ...
    {
        .categoryName = _("Medusa fantasma"),
        .height = 12,
        .weight = 330,
    ...
    {
        .categoryName = _("Anguila eléctrica"),
        .height = 12,
        .weight = 220,
    ...
    {
        .categoryName = _("Quebrantahuesos"),
        .height = 12,
        .weight = 395,
    ...
    {
        .categoryName = _("Conejo excavador"),
        .height = 4,
        .weight = 50,
    ...
    {
        .categoryName = _("Árbol embrujado"),
        .height = 15,
        .weight = 710,
    ...
    {
        .categoryName = _("Estrella tóxica"),
        .height = 7,
        .weight = 145,
    ...
    {
        .categoryName = _("Caballo de tiro"),
        .height = 25,
        .weight = 9200,
    ...
    {
        .categoryName = _("Lagartija venenosa"),
        .height = 6,
        .weight = 48,
    ...
    {
        .categoryName = _("Lagarto venenoso"),
        .height = 12,
        .weight = 222,
    ...
    {
        .categoryName = _("Medusa espacial"),
        .height = 12,
        .weight = 555,
    ...
    {
        .categoryName = _("Fuegos artificiales"),
        .height = 18,
        .weight = 130,
    ...
    [NATIONAL_DEX_SNOM] =
    {
        .categoryName = _("Oruga de cristal"),
        .height = 3,
        .weight = 38,
    ...
    {
        .categoryName = _("Polilla invernal"),
        .height = 13,
        .weight = 420,
    ...
    {
        .categoryName = _("Caimán de fuego"),
        .height = 10,
        .weight = 307,
    ...
    {
        .categoryName = _("Dragón de hielo"),
        .height = 21,
        .weight = 2100,
    ...
    {
        .categoryName = _("Héroe de sombra"),
        .height = 16,
        .weight = 620,
