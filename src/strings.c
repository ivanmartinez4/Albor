...
const u8 gText_DepositHowManyVar1[] = _("¿Cuántos quieres guardar?");
const u8 gText_DepositedVar2Var1s[] = _("{STR_VAR_2} guardado.");
...
const u8 gText_TossHowManyVar1s[] = _("¿Cuántos{STR_VAR_1}(s)\n quieres tirar?");
const u8 gText_ThrewAwayVar2Var1s[] = _("Has tirado {STR_VAR_2}\n{STR_VAR_1}(s).");
const u8 gText_ConfirmTossItems[] = _("¿Quieres tirar\n {STR_VAR_2}\n{STR_VAR_1}(s)?");
...
const u8 gText_DoWhatWithItem[] = _("¿Qué objeto?");
...
const u8 gText_Stats_Growthrate[]    = _("Crecimiento: ");
