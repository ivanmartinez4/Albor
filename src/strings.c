...
const u8 gText_ShopQuit[] = _("Quitar");
...
const u8 gText_ThrowInPremierBalls[] = _("Te pongo unas Premier Balls también.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggWillTakeSomeTime[] = _("Aún le queda alto de tiempo.");
