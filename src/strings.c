...
//HGSS_Ui PokedexPlus
const u8 gText_Stats_Buttons[]  = _("{A_BUTTON}TOGGLE   {DPAD_UPDOWN}Movimientos");
const u8 gText_Stats_Buttons_Decapped[]  = _("{A_BUTTON}Toggle   {DPAD_UPDOWN}Movimientos");
...
const u8 gText_Stats_SpAttack[]    = _("At. esp.");
const u8 gText_Stats_SpDefense[]    = _("Def. esp.");
...
const u8 gText_Stats_ExpYield[]      = _("Puntos de experiencia: ");
const u8 gText_Stats_EggCycles[]     = _("Pasos para eclosión:");
