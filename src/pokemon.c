...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
 ...
 // Alolan Forms
    ...
    // Gimmighoul
    [SPECIES_GIMMIGHOUL_CHEST - 1] = NATIONAL_DEX_GIMMIGHOUL,
};
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_SNEASLER - 1]      = ANIM_H_JUMPS,
    [SPECIES_OVERQWIL - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ENAMORUS - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SPRIGATITO - 1]    = ANIM_FLICKER,
    [SPECIES_FLORAGATO - 1]     = ANIM_FLICKER,
    [SPECIES_MEOWSCARADA - 1]   = ANIM_FLICKER,
    [SPECIES_FUECOCO - 1]       = ANIM_GLOW_RED,
    [SPECIES_CROCALOR - 1]      = ANIM_GLOW_RED,
    [SPECIES_SKELEDIRGE - 1]    = ANIM_GLOW_RED,
    [SPECIES_QUAXLY - 1]        = ANIM_DEEP_V_SQUISH_AND_BOUNCE_TWICE,
    [SPECIES_QUAXWELL - 1]      = ANIM_DEEP_V_SQUISH_AND_BOUNCE_TWICE,
    [SPECIES_QUAQUAVAL - 1]     = ANIM_DEEP_V_SQUISH_AND_BOUNCE_TWICE,
    [SPECIES_NYMBLE - 1]        = ANIM_BACK_FLIP,
    [SPECIES_LOKIX - 1]         = ANIM_BACK_FLIP_BIG,
    [SPECIES_SMOLIV - 1]        = ANIM_V_REPEATED_SPRING,
    [SPECIES_DOLLIV - 1]        = ANIM_V_REPEATED_SPRING,
    [SPECIES_ARBOLIVA - 1]      = ANIM_V_SPRING,
    [SPECIES_TADBULB - 1]       = ANIM_ROTATE_TO_SIDES_FAST,
    [SPECIES_BELLIBOLT - 1]     = ANIM_VIBRATE_TO_CORNERS,
    [SPECIES_SHROODLE - 1]      = ANIM_H_SLIDE_SHRINK,
    [SPECIES_GRAFAIAI - 1]      = ANIM_GLOW_PURPLE,
    [SPECIES_CAPSAKID - 1]      = ANIM_SHAKE_GLOW_RED,
    [SPECIES_SCOVILLAIN - 1]    = ANIM_SHAKE_GLOW_RED,
    [SPECIES_FLITTLE - 1]       = ANIM_SWING_CONVEX_FAST_SHORT,
    [SPECIES_ESPATHRA - 1]      = ANIM_SWING_CONVEX_FAST_SHORT,
    [SPECIES_TINKATINK - 1]     = ANIM_TIP_HOP_FORWARD,
    [SPECIES_TINKATUFF - 1]     = ANIM_TIP_HOP_FORWARD,
    [SPECIES_TINKATON - 1]      = ANIM_TIP_HOP_FORWARD,
    [SPECIES_VAROOM - 1]        = ANIM_V_SHAKE,
    [SPECIES_REVAVROOM - 1]     = ANIM_V_SHAKE,
    [SPECIES_ORTHWORM - 1]      = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_GREAVARD - 1]      = ANIM_V_SHAKE_TWICE_SLOW,
    [SPECIES_HOUNDSTONE - 1]    = ANIM_V_SHAKE_SLOW,
    [SPECIES_CETODDLE - 1]      = ANIM_SPIN_LONG,
    [SPECIES_CETITAN - 1]       = ANIM_TUMBLING_FRONT_FLIP,
    [SPECIES_ANNIHILAPE - 1]    = ANIM_TIP_AND_SHAKE,
    [SPECIES_KLAWF - 1]         = ANIM_ROTATE_TO_SIDES,
    [SPECIES_FRIGIBAX - 1]      = ANIM_PIVOT_SHAKE,
    [SPECIES_ARCTIBAX - 1]      = ANIM_PIVOT_SHAKE,
    [SPECIES_BAXCALIBUR - 1]    = ANIM_PIVOT_SHAKE,
    [SPECIES_GIMMIGHOUL - 1]    = ANIM_GLOW_YELLOW,
    [SPECIES_GHOLDENGO - 1]     = ANIM_GLOW_YELLOW,
    [SPECIES_CHARCADET - 1]     = ANIM_SHAKE_GLOW_WHITE_SLOW,
    [SPECIES_ARMAROUGE - 1]     = ANIM_SHAKE_GLOW_RED_SLOW,
    [SPECIES_CERULEDGE - 1]     = ANIM_GLOW_BLACK,
    ...
    [SPECIES_GIMMIGHOUL_CHEST - 1]          = ANIM_GLOW_YELLOW,
};
