...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tBorderColor = gSaveBlock2Ptr->optionsBorderColor;
        ...
        BorderColor_DrawChoices(gTasks[taskId].tBorderColor);
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    else
    {
        ...
        case MENUITEM_BORDERCOLOR:
            previousOption = gTasks[taskId].tBorderColor;
            gTasks[taskId].tBorderColor = BorderColor_ProcessInput(gTasks[taskId].tBorderColor);

            if (previousOption != gTasks[taskId].tBorderColor)
                BorderColor_DrawChoices(gTasks[taskId].tBorderColor);
            break;
        case MENUITEM_SOUND:
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsBorderColor = gTasks[taskId].tBorderColor;
