...
#define BAG_BERRIES_COUNT 41
#define OBJECT_EVENT_TEMPLATES_COUNT 64
#define DECOR_MAX_SECRET_BASE 1
#define DECOR_MAX_PLAYERS_HOUSE 1
#define MAX_REMATCH_ENTRIES 2 // only REMATCH_TABLE_ENTRIES (78) are used
...
#define EASY_CHAT_BATTLE_WORDS_COUNT 1
#define MOVE_NAME_LENGTH 16
#define NUM_QUESTIONNAIRE_WORDS 1
#define QUIZ_QUESTION_LEN 1
#define WONDER_CARD_TEXT_LENGTH 1
#define WONDER_NEWS_TEXT_LENGTH 1
#define WONDER_CARD_BODY_TEXT_LINES 1
#define WONDER_NEWS_BODY_TEXT_LINES 1
#define TYPE_NAME_LENGTH 9
#define ABILITY_NAME_LENGTH 17
...
#define BARD_SONG_LENGTH       1
#define NUM_STORYTELLER_TALES  1
#define NUM_TRADER_ITEMS       1
...
#define OPTIONS_BORDER_COLOR_GREEN 0
#define OPTIONS_BORDER_COLOR_BLUE 1
#define OPTIONS_BORDER_COLOR_RED 2
